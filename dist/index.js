...
Displace$1.vertexShader = `
    ...
    `;
Displace$1.type = 'perlin';
Displace$1.mapping = 'local';
...
class Shader$1 extends Abstract {
  constructor(props) {
    super(Shader$1, {
      name: 'Shader',
      extern: true,
  ...
  load(url, onLoad, onError) {
    fetch(url).then(resp => resp.json().then(async json => {
      if (json.metadata.type === 'mat') {
        ...
        const mat = new LayerMaterial$1({ ...data.base.currents,
          layers
        });
...
const LayerMaterial = /*#__PURE__*/React__default.forwardRef(({
  children,
  ...props
}, forwardRef) => {
  ...
  return /*#__PURE__*/React__default.createElement("layerMaterial", _extends({
    args: args,
    ref: mergeRefs([ref, forwardRef])
  }, props), children);
});
const Depth = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement("depth_", _extends({
    ref: ref
  }, props));
});
const Color = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement("color_", _extends({
    ref: ref
  }, props));
});
const Noise = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement("noise_", _extends({
    ref: ref
  }, props));
});
const Fresnel = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement("fresnel_", _extends({
    ref: ref
  }, props));
});
const Gradient = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement("gradient_", _extends({
    ref: ref
  }, props));
});
const Matcap = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement("matcap_", _extends({
    ref: ref
  }, props));
});
const Texture = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement("texture_", _extends({
    ref: ref
  }, props));
});
const Displace = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement("displace_", _extends({
    ref: ref
  }, props));
});
const Normal = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement("normal_", _extends({
    ref: ref
  }, props));
});
const Shader = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  return /*#__PURE__*/React__default.createElement("shader_", _extends({
    ref: ref
  }, props));
});

function useLamina(url) {
  // @ts-ignore
  const material = useLoader(LaminaLoader, url);
  return material instanceof LayerMaterial$1 ? /*#__PURE__*/React.forwardRef((props, forwardRef) => {
    const ref = React.useRef(null);
    return /*#__PURE__*/React.createElement(LayerMaterial, _extends({
      ref: mergeRefs([ref, forwardRef])
    }, material.serialize().currents, props), material.layers.map(e => /*#__PURE__*/React.createElement("primitive", {
      key: e.uuid,
      object: e
    })), props.children);
...
export { Color, Depth, Displace, Fresnel, Gradient, LayerMaterial, Matcap, Noise, Normal, Shader, Texture, useLamina };
