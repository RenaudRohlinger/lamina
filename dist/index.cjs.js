...
const Depth = /*#__PURE__*/React__default["default"].forwardRef((props, ref) => {
...
const Shader = /*#__PURE__*/React__default["default"].forwardRef((props, ref) => {
  return /*#__PURE__*/React__default["default"].createElement("shader_", _extends__default["default"]({
    ref: ref
  }, props));
});
...
function useLamina(url) {
  // @ts-ignore
  const material = fiber.useLoader(LaminaLoader, url);
  return material instanceof LayerMaterial$1 ? /*#__PURE__*/React__namespace.forwardRef((props, forwardRef) => {
    const ref = React__namespace.useRef(null);
    return /*#__PURE__*/React__namespace.createElement(LayerMaterial, _extends__default["default"]({
      ref: mergeRefs__default["default"]([ref, forwardRef])
    }, material.serialize().currents, props), material.layers.map(e => /*#__PURE__*/React__namespace.createElement("primitive", {
      key: e.uuid,
      object: e
    })), props.children);
  }) : /*#__PURE__*/React__namespace.forwardRef((props, ref) => {
    return /*#__PURE__*/React__namespace.createElement("primitive", _extends__default["default"]({
      ref: ref,
      object: material
    }, props));
  });
